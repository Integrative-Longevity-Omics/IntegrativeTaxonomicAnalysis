---
title: "Alpha diversity analysis with metaphlan4 data with genome bins from Xu et al Chinese cohort"
...
#specify file path
flpath <- "/restricted/projectnb/uh2-sebas/data/metagenomics/external_cohorts/Han_Chinese_Centenarian/processed_data/data_library/manuscript_review_data_09.17.2025/"
outpath <- "/restricted/projectnb/uh2-sebas/analysis/metagenomics/parallel_systems_comparison/03_alpha_diversity_analysis/Xu_genomebins/output/"
...
otufl <- "metaphlan4_renorm_chinese_genomebins_phyloseq.09.17.2025.rds"
...
write_csv(ctds.list, file=paste0(outpath,"entropy.metaphlan4.genomebins.chinese.csv"))
```
...
png(paste0(outpath,"Figures/metaphlan/entropy_metaphlan_chinese_alllevels.png"), units="in", width=30, height=20, res=300)
ggpubr::ggarrange(p.p_age, p.c_age, p.o_age, p.f_age, p.g_age, p.s_age,
          ncol = 3, nrow = 2)
dev.off()
