---
title: "Alpha diversity analysis with metaphlan4 data with genome bins from ILO cohort"
...
#specify file path
flpath <- "/restricted/projectnb/uh2-sebas/data/metagenomics/ILO_combined_cohort/processed_data/data_library/manuscript_review_data_09.17.2025/"
qcpath <- "/restricted/projectnb/uh2-sebas/data/metagenomics/ILO_comined_cohort/processed_data/qc_analysis/"
outpath <- "/restricted/projectnb/uh2-sebas/analysis/metagenomics/parallel_systems_comparison/03_alpha_diversity_analysis/ILO_genomebins/output/"
meta.dir <-"/restricted/projectnb/uh2-sebas/data/metagenomics/ILO_combined_cohort/decoder/archived/"

otufl <- "metaphlan4_genomebins_renorm_ILO_phyloseq.09.17.2025.rds"
...
write_csv(ctds.list, file=paste0(outpath,"entropy.metaphlan4.genomebins.ilo.csv"))
```
...
png(paste0(outpath,"Figures/metaphlan/entropy_metaphlan_ilo_alllevels.png"), units="in", width=30, height=20, res=300)
ggpubr::ggarrange(p.p_age, p.c_age, p.o_age, p.f_age, p.g_age, p.s_age,
          ncol = 3, nrow = 2)
dev.off()
