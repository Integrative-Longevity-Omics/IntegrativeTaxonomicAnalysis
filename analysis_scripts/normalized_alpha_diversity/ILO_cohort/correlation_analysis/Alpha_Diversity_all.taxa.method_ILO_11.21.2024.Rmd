---
title: "Alpha diversity analysis with ILO cohort data based on all taxa between taxonomic classification methods"
...
#metaphlan adjusted entropy scores across all taxonomic levels
metaphlan_entropy <- "entropy.metaphlan4.ilo.csv"
#bracken adjusted entropy scores across all taxonomic levels
#with log10 read count threshold 1 and unique kmer minimizer count threshold 3
bracken_entropy <- "entropy.bracken.ilo.R1.K3.csv"
...
#save figures
png(paste0(outpath,"Figures/all_taxa_method_comparison/entropy_methodcomp_all.taxa_ilo_alllevels.png"), units="in", width=30, height=20, res=300)
ggpubr::ggarrange(p.p_comp, p.c_comp, p.o_comp, p.f_comp, p.g_comp, p.s_comp,
           ncol = 3, nrow = 2)
dev.off()
 
png(paste0(outpath,"Figures/all_taxa_method_comparison/entropy_methodcomp_all.taxa_ilo_main.png"), units="in", width=30, height=10, res=300)
ggpubr::ggarrange(p.p_comp, p.g_comp, p.s_comp,
           ncol = 3, nrow = 1)
dev.off()

png(paste0(outpath,"Figures/all_taxa_method_comparison/entropy_methodcomp_all.taxa_ilo_supp.png"), units="in", width=30, height=10, res=300)
