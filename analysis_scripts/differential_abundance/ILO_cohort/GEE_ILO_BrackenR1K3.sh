...
OUTDIR="/restricted/projectnb/uh2-sebas/analysis/metagenomics/ye_analyses/Output/ILO_Bracken/"
PHENODIR="/restricted/projectnb/uh2-sebas/data/metagenomics/ILO_combined_cohort/decoder/2024-11-18.cleaned.metag.list.csv"
BIOMDIR="bracken_renorm_ILO_phyloseq.R1.K3.10.09.2024.rds"
OUTNAME="ILOBrackenR1K3_10312024"
METHOD="GEE"
...
#$ -P uh2-sebas
#$ -l h_rt=12:00:00
#$ -N GEE_ILO_BrackenR1K3
#$ -j y

module load R/4.3.1

Rscript /restricted/projectnb/uh2-sebas/analysis/metagenomics/ye_analyses/Scripts/Differential_Abundance/ILO_Bracken/GEE_ILO_Bracken.R -f "$arg1" -o "$arg2" -b "$arg3" -t "$arg4" -n "$arg5" -m "$arg6" -p "$arg7"
