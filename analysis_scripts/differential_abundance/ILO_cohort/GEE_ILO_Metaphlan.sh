...
OUTDIR="/restricted/projectnb/uh2-sebas/analysis/metagenomics/ye_analyses/Output/ILO_Metaphlan/"
PHENODIR="/restricted/projectnb/uh2-sebas/data/metagenomics/ILO_combined_cohort/decoder/2024-11-18.cleaned.metag.list.csv"
BIOMDIR="metaphlan4_renorm_ILO_phyloseq.09.30.2024.rds"
OUTNAME="ILOMetaphlan_10302024"
METHOD="GEE"
...
Rscript /restricted/projectnb/uh2-sebas/analysis/metagenomics/ye_analyses/Scripts/Differential_Abundance/ILO_Metaphlan/GEE_ILO_Metaphlan.R -f "$arg1" -o "$arg2" -b "$arg3" -t "$arg4" -n "$arg5" -m "$arg6" -p "$arg7"
