...
OUTDIR="/restricted/projectnb/uh2-sebas/analysis/metagenomics/ye_analyses/Output/Asian_Bracken/"
...
BIOMDIR="bracken_renorm_chinese_phyloseq.R1.K3.10.22.2024.rds"
OUTNAME="AsianBrackenR1K3_11052024"
METHOD="GEE"
...
#$ -P uh2-sebas
#$ -l h_rt=12:00:00
#$ -N GEE_Asian_BrackenR1K3
#$ -j y

module load R/4.3.1

Rscript /restricted/projectnb/uh2-sebas/analysis/metagenomics/ye_analyses/Scripts/Differential_Abundance/Asian_Bracken/GEE_Asian_Bracken.R -f "$arg1" -o "$arg2" -b "$arg3" -t "$arg4" -n "$arg5" -m "$arg6" -p "$arg7"
