---
title: "Beta diversity analysis with Bracken ILO data with read threshold 1 and kmer minimizer threshold 3"
...
library(umap)
#library(reticulate)
#py_install("umap-learn") #to install umap-learn
...
kraken2uniq_tse <- mia::makeTreeSummarizedExperimentFromPhyloseq(subset_ilo_biom)
kraken2uniq_tse
...
write_xlsx(BC_list, paste0(outpath,"BC_bracken_ILO.R1.K3.xlsx"))
```

# Uniqueness across taxonomic levels

## Age at fecal sample collection (continuous)
...
saveRDS(pcoa_list, paste0(outpath,"pcoa_bracken_ILO.R1.K3.rds"))
write_xlsx(pcoa_list, paste0(outpath,"pcoa_bracken_ILO.R1.K3.xlsx"))
```
...
#save figures
png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_alllevels.png"), units="in", width=50, height=20, res=300)
ggpubr::ggarrange(p.phylum, p.class, p.order, p.legend, p.family, p.genus, p.species, ncol = 4, nrow = 2)
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_main.png"), units="in", width=40, height=12, res=300)
ggpubr::ggarrange(p.phylum, p.genus, p.species, p.legend, ncol = 4, nrow = 1)
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_supp.png"), units="in", width=40, height=12, res=300)
...
#save each plot
png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_phylum.png"), units="in", width=12, height=10, res=300)
p.phylum
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_class.png"), units="in", width=12, height=10, res=300)
p.class
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_order.png"), units="in", width=12, height=10, res=300)
p.order
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_family.png"), units="in", width=12, height=10, res=300)
p.family
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_genus.png"), units="in", width=12, height=10, res=300)
p.genus
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/pcoa_bracken_R1_K3_ilo_species.png"), units="in", width=12, height=10, res=300)
p.species
dev.off()
```
