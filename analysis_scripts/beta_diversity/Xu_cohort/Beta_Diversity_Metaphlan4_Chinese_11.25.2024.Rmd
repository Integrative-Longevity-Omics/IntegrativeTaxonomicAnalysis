---
title: "Beta diversity analysis of metaphlan4 Xu et al chinese cohort filtered/processed data"
...
metaphlan_tse <- mia::makeTreeSummarizedExperimentFromPhyloseq(subset_chinese_biom)
metaphlan_tse
...
write_xlsx(BC_list, paste0(outpath,"BC_metaphlan_chinese.xlsx"))
```
...
saveRDS(pcoa_list, paste0(outpath,"pcoa_metaphlan4_chinese.rds"))
write_xlsx(pcoa_list, paste0(outpath,"pcoa_metaphlan4_chinese.xlsx"))
```
...
#save figures
png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_alllevels.png"), units="in", width=50, height=20, res=300)
ggpubr::ggarrange(p.phylum, p.class, p.order, p.legend, p.family, p.genus, p.species, ncol = 4, nrow = 2)
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_main.png"), units="in", width=40, height=12, res=300)
ggpubr::ggarrange(p.phylum, p.genus, p.species, p.legend, ncol = 4, nrow = 1)
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_supp.png"), units="in", width=40, height=12, res=300)
...
#save each plot
png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_phylum.png"), units="in", width=12, height=10, res=300)
p.phylum
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_class.png"), units="in", width=12, height=10, res=300)
p.class
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_order.png"), units="in", width=12, height=10, res=300)
p.order
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_family.png"), units="in", width=12, height=10, res=300)
p.family
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_genus.png"), units="in", width=12, height=10, res=300)
p.genus
dev.off()

png(paste0(outpath,"Figures/metaphlan/pcoa_metaphlan_chinese_species.png"), units="in", width=12, height=10, res=300)
p.species
dev.off()
```