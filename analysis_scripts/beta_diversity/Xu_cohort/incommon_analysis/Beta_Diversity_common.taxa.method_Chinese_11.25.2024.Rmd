---
title: "Beta diversity analysis with Xu et al chinese cohort data based in-common taxa between taxonomic classification methods"
...
```{r}
#save as tibbles
metaphlan_chinese_renorm.t <- metaphlan_chinese_renorm.otu %>% as_tibble(rownames="tax.ID")
bracken_chinese_renorm.t <- bracken_chinese_renorm.otu %>% as_tibble(rownames="tax.ID")

#metphlan phyloseq obj
metaphlan.common.phy <- phyloseq::phyloseq(otu_table(metaphlan_chinese_renorm.otu, taxa_are_rows = TRUE), tax_table(metaphlan_taxa_total %>% as.matrix),  sample_data(metaphlan.samp.dat))
metaphlan.common.phy

#bracken phyloseq obj
bracken.common.phy <- phyloseq::phyloseq(otu_table(bracken_chinese_renorm.otu, taxa_are_rows = TRUE), tax_table(bracken_taxa_total %>% as.matrix),  sample_data(bracken.samp.dat))
bracken.common.phy
```
...
write_xlsx(BC_list, paste0(outpath,"BC_metaphlan.commontaxa_chinese.xlsx"))
```
...
write_xlsx(BC_list, paste0(outpath,"BC_bracken.commontaxa_chinese.xlsx"))
```

# Metaphlan: Uniqueness

```{r metaphlan uniqueness, fig.dim = c(20,10)}
p.s_age <- ggplot(metaphlan_b.species, aes(x=c_age_years, y=uniqueness)) + 
...
#For genus level
p.g_age <- ggplot(metaphlan_b.genus, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) +
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For family level
p.f_age <- ggplot(metaphlan_b.family, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For order level
p.o_age <- ggplot(metaphlan_b.order, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For class level
p.c_age <- ggplot(metaphlan_b.class, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For phylum level
p.p_age <- ggplot(metaphlan_b.phylum, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
p.s_age <- ggplot(bracken_b.species, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For genus level
p.g_age <- ggplot(bracken_b.genus, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) +
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For family level
p.f_age <- ggplot(bracken_b.family, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For order level
p.o_age <- ggplot(bracken_b.order, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For class level
p.c_age <- ggplot(bracken_b.class, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
#For phylum level
p.p_age <- ggplot(bracken_b.phylum, aes(x=c_age_years, y=uniqueness)) + 
    geom_point(fill="blue") + 
    ylim(0,1) + 
    theme_bw(base_size = 20) +
    theme(axis.title.y=element_blank(), axis.title.x=element_blank(),
...
saveRDS(metaphlan.uniqueness, paste0(outpath,"metaphlan.chinese.commontaxa.bc.uniqueness.rds"))
...
saveRDS(bracken.uniqueness, paste0(outpath,"bracken.chinese.commontaxa.bc.uniqueness.rds"))
```
...
D.chinese.otu.mat <- as.matrix(metaphlan_beta.div.species)

#Complex heatmap

samp.dat <- metaphlan.common.phy@sam_data
samp.dat.ordered <- samp.dat[rownames(D.chinese.otu.mat),]
...
h.species <- ComplexHeatmap::Heatmap(D.chinese.otu.mat, name = "Bray Curtis Index", show_row_names = F, show_column_names = F, row_names_gp = gpar(fontsize = 10), na_col = "white")
...
pm.metaphlan.species<-adonis2(metaphlan_dist_matrix.species~as.integer(samp.dat.species$c_age_years), data=samp.dat.species, permutations=999, by="margin")
...
D.chinese.otu.mat <- as.matrix(bracken_beta.div.species)
...
pm.bracken.species<-adonis2(bracken_dist_matrix.species~as.integer(samp.dat.species$c_age_years), data=samp.dat.species, permutations=999, by="margin")
pm.bracken.species
```
...
D.chinese.otu.mat <- as.matrix(metaphlan_beta.div.genus)
...
h.genus <- ComplexHeatmap::Heatmap(D.chinese.otu.mat, cluster_rows = T, cluster_columns = T, name = "Bray Curtis Index", show_row_names = F, show_column_names = F, row_names_gp = gpar(fontsize = 10), na_col = "white")
#bottom_annotation = column.anno, right_annotation = row.anno)
...
pm.metaphlan.genus<-adonis2(metaphlan_dist_matrix.genus~as.integer(samp.dat.genus$c_age_years), data=samp.dat.genus, permutations=999, by="margin")
pm.metaphlan.genus
```
...
D.chinese.otu.mat <- as.matrix(bracken_beta.div.genus)
...
pm.bracken.genus<-adonis2(bracken_dist_matrix.genus~as.integer(samp.dat.genus$c_age_years), data=samp.dat.genus, permutations=999, by="margin")
pm.bracken.genus
```
...
D.chinese.otu.mat <- as.matrix(metaphlan_beta.div.family)
...
h.family <- ComplexHeatmap::Heatmap(D.chinese.otu.mat, cluster_rows = T, cluster_columns = T, name = "Bray Curtis Index", show_row_names = F, show_column_names = F, row_names_gp = gpar(fontsize = 10), na_col = "white") #bottom_annotation = column.anno, right_annotation = row.anno)
...
pm.metaphlan.family<-adonis2(metaphlan_dist_matrix.family~as.integer(samp.dat.family$c_age_years), data=samp.dat.family, permutations=999, by="margin")
pm.metaphlan.family
```
...
D.chinese.otu.mat <- as.matrix(bracken_beta.div.family)
...
pm.bracken.family<-adonis2(bracken_dist_matrix.family~as.integer(samp.dat.family$c_age_years), data=samp.dat.family, permutations=999, by="margin")
pm.bracken.family
```
...
D.chinese.otu.mat <- as.matrix(metaphlan_beta.div.order)
...
h.order <- ComplexHeatmap::Heatmap(D.chinese.otu.mat, cluster_rows = T, cluster_columns = T, name = "Bray Curtis Index", show_row_names = F, show_column_names = F, row_names_gp = gpar(fontsize = 10), na_col = "white") #bottom_annotation = column.anno, right_annotation = row.anno)
...
pm.metaphlan.order<-adonis2(metaphlan_dist_matrix.order~as.integer(samp.dat.order$c_age_years), data=samp.dat.order, permutations=999, by="margin")
pm.metaphlan.order
```
...
D.chinese.otu.mat <- as.matrix(bracken_beta.div.order)
...
pm.bracken.order<-adonis2(bracken_dist_matrix.order~as.integer(samp.dat.order$c_age_years), data=samp.dat.order, permutations=999, by="margin")
pm.bracken.order
```
...
D.chinese.otu.mat <- as.matrix(metaphlan_beta.div.class)

#Complex heatmap

samp.dat <- metaphlan.common.phy@sam_data
samp.dat.classed <- samp.dat[rownames(D.chinese.otu.mat),]
...
h.class <- ComplexHeatmap::Heatmap(D.chinese.otu.mat, cluster_rows = T, cluster_columns = T, name = "Bray Curtis Index", show_row_names = F, show_column_names = F, row_names_gp = gpar(fontsize = 10), na_col = "white") #bottom_annotation = column.anno, right_annotation = row.anno)
...
pm.metaphlan.class<-adonis2(metaphlan_dist_matrix.class~as.integer(samp.dat.class$c_age_years), data=samp.dat.class, permutations=999, by="margin")
pm.metaphlan.class
```
...
D.chinese.otu.mat <- as.matrix(bracken_beta.div.class)
...
pm.bracken.class<-adonis2(bracken_dist_matrix.class~as.integer(samp.dat.class$c_age_years), data=samp.dat.class, permutations=999, by="margin")
pm.bracken.class
```
...
D.chinese.otu.mat <- as.matrix(metaphlan_beta.div.phylum)

#Complex heatmap

samp.dat <- metaphlan.common.phy@sam_data
samp.dat.phylumed <- samp.dat[rownames(D.chinese.otu.mat),]
...
h.phylum <- ComplexHeatmap::Heatmap(D.chinese.otu.mat, cluster_rows = T, cluster_columns = T, name = "Bray Curtis Index", show_row_names = F, show_column_names = F, row_names_gp = gpar(fontsize = 10), na_col = "white") #bottom_annotation = column.anno, right_annotation = row.anno)
...
pm.metaphlan.phylum<-adonis2(metaphlan_dist_matrix.phylum~as.integer(samp.dat.phylum$c_age_years), data=samp.dat.phylum, permutations=999, by="margin")
pm.metaphlan.phylum
```
...
D.chinese.otu.mat <- as.matrix(bracken_beta.div.phylum)
...
pm.bracken.phylum<-adonis2(bracken_dist_matrix.phylum~as.integer(samp.dat.phylum$c_age_years), data=samp.dat.phylum, permutations=999, by="margin")
pm.bracken.phylum
```
...
saveRDS(pcoa_list, paste0(outpath,"pcoa_metaphlan4_common.taxa_chinese.rds"))
write_xlsx(pcoa_list, paste0(outpath,"pcoa_metaphlan4_common.taxa_chinese.xlsx"))
```
...
png(paste0(outpath,"Figures/incommon_taxa/pcoa_bray_metaphlan_common.taxa_chinese_alllevels.png"), units="in", width=40, height=20, res=300)
ggpubr::ggarrange(p.phylum, p.class, p.order, p.legend, p.family, p.genus, p.species, ncol = 4, nrow = 2)
dev.off()

png(paste0(outpath,"Figures/incommon_taxa/pcoa_bray_metaphlan_common.taxa_chinese_main.png"), units="in", width=30, height=10, res=300)
...
saveRDS(pcoa_list, paste0(outpath,"pcoa_bracken_common.taxa_chinese.rds"))
write_xlsx(pcoa_list, paste0(outpath,"pcoa_bracken_common.taxa_chinese.xlsx"))
```
...
dir.create(paste0(outpath,"Figures/incommon_taxa"))
png(paste0(outpath,"Figures/incommon_taxa/pcoa_bray_bracken_common.taxa_chinese_alllevels.png"), units="in", width=40, height=20, res=300)
ggpubr::ggarrange(p.phylum, p.class, p.order, p.legend, p.family, p.genus, p.species, ncol = 4, nrow = 2)
dev.off()

png(paste0(outpath,"Figures/incommon_taxa/pcoa_bray_bracken_common.taxa_chinese_main.png"), units="in", width=30, height=10, res=300)
ggpubr::ggarrange(p.phylum, p.genus, p.species, p.legend, ncol = 4, nrow = 1)
dev.off()
```
...
png(paste0(outpath,"Figures/incommon_taxa/mantel_test_common.taxa_chinese_alllevels.png"), units="in", width=20, height=5, res=300)
p.mantel
dev.off()
```
...
png(paste0(outpath,"Figures/incommon_taxa/mantel_test_common.taxa_chinese_main.png"), units="in", width=10, height=5, res=300)
p.mantel
dev.off()
```
