---
title: "Richness analysis with Bracken ILO data with read threshold 1 and kmer minimizer threshold 3"
...
otufl <- "bracken_renorm_ILO_phyloseq.R1.K3.10.09.2024.rds"
...
# Alpha diversity analysis using richness (count of taxa) 
...
#OTU_order <- OTU_filtered[,samples.beta.kraken2.ilo$sample.keep.order]
...
write_csv(ctds.list, file=paste0(outpath,"richness.bracken.ilo.R1.K3.csv"))
...
## Visualize changes in richness (count of taxa) with age
...
png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_alllevels.png"), units="in", width=30, height=20, res=300)
ggpubr::ggarrange(p.p_age, p.c_age, p.o_age, p.f_age, p.g_age, p.s_age,
          ncol = 3, nrow = 2)
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_main.png"), units="in", width=30, height=10, res=300)
...
png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_supp.png"), units="in", width=30, height=10, res=300)
...
#save each plot
png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_phylum.png"), units="in", width=10, height=12, res=300)
p.p_age
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_class.png"), units="in", width=10, height=12, res=300)
p.c_age
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_order.png"), units="in", width=10, height=12, res=300)
p.o_age
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_family.png"), units="in", width=10, height=12, res=300)
p.f_age
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_genus.png"), units="in", width=10, height=12, res=300)
p.g_age
dev.off()

png(paste0(outpath,"Figures/bracken_R1_K3/richness_bracken_R1_K3_ilo_species.png"), units="in", width=10, height=12, res=300)
p.s_age
dev.off()
