---
title: "Richness analysis with metaphlan4 data from Xu et al Chinese cohort"
...
write_csv(ctds.list, file=paste0(outpath,"richness.metaphlan4.chinese.csv"))
```
...
png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_alllevels.png"), units="in", width=30, height=20, res=300)
ggpubr::ggarrange(p.p_age, p.c_age, p.o_age, p.f_age, p.g_age, p.s_age,
          ncol = 3, nrow = 2)
dev.off()

png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_main.png"), units="in", width=30, height=10, res=300)
...
png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_supp.png"), units="in", width=30, height=10, res=300)
...
#save each plot
png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_phylum.png"), units="in", width=10, height=12, res=300)
p.p_age
dev.off()

png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_class.png"), units="in", width=10, height=12, res=300)
p.c_age
dev.off()

png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_order.png"), units="in", width=10, height=12, res=300)
p.o_age
dev.off()

png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_family.png"), units="in", width=10, height=12, res=300)
p.f_age
dev.off()

png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_genus.png"), units="in", width=10, height=12, res=300)
p.g_age
dev.off()

png(paste0(outpath,"Figures/metaphlan/richness_metaphlan_chinese_species.png"), units="in", width=10, height=12, res=300)
p.s_age
dev.off()
